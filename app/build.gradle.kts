    ...
    signingConfigs {
        create("release") {
            ...
            if (storeFile != null && storeFile.exists()) {
                ...
                if (storePassword.isNotBlank()) this.storePassword = storePassword
                if (keyPassword.isNotBlank()) this.keyPassword = keyPassword
                if (keyAlias.isNotBlank()) this.keyAlias = keyAlias
            }
        }
    }
